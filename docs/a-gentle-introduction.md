...
- Developers use Arbitrum to build high-performance decentralized apps with extremely low transaction costs. See our [gas cost estimator](https://gas.arbitrum.io/) and [L2Fees](https://l2fees.info/) for details.
