...
1. Go to the Arbitrum DAO page on Tally (TODO), the decentralized governance platform that the Arbitrum DAO uses.
2. Connect your wallet to Tally by clicking on "Connect Wallet" and selecting the wallet you're using to hold your $ARB tokens.
