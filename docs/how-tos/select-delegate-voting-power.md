...
description: Learn how to delegate your voting power to a values-aligned
  ArbitrumDAO delegate.
...
Delegating your voting power is an essential part of participating in the <a data-quicklook-from='arbitrum-dao'>ArbitrumDAO</a>. As a token holder, you have the ability to vote on governance <a data-quicklook-from='arbitrum-improvement-proposal-aip'>proposals</a> and to elect members of the <a data-quicklook-from='security-council'>Security Council</a>. 
...
1. Go to the ArbitrumDAO page in the [on-chain governance UI](https://alt.gov.arbitrum.foundation/).
2. Connect your wallet by clicking on "Connect Wallet" and selecting the address that holds your $ARB tokens.
3. Click on the "Delegates" tab on the top menu.
...
* The delegate's values, as outlined in the [Constitution](../dao-constitution) and their position on the proposals.
...
By following these steps and considering these factors, you can ensure that you're delegating your voting power to a trustworthy and competent delegate who will work to further the goals of the ArbitrumDAO and its community. If you have any questions or concerns, visit the [ArbitrumDAO governance forum](https://forum.arbitrum.foundation/).
