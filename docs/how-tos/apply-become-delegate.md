...
In this how-to, you'll learn how to apply to become a <a data-quicklook-from='delegate'>delegate</a> for the <a data-quicklook-from='arbitrum-dao'>Arbitrum DAO</a>. As a delegate, you'll have the ability to vote on proposals, including those that propose changes to the Constitution and other critical protocol parameters.
