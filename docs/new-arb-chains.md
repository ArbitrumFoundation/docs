...
The following section covers the basics on Arbitrum chains and the Arbitrum Expansion program, that enables projects to easily adopt the Arbitrum technology stack when deploying their own chain. 

## Arbitrum chains 

Arbitrum chains represent our strategy for enabling projects seeking to adopt the Arbitrum technology stack when deciding to deploy their own chain.

There are many reasons why a project will decide to launch their chain using Arbitrum chains:
...
- **Low latency.** Arbitrum chains have demonstrated the ability to sustain ~100ms block times. 
- **Data availability layer choices.** AnyTrust, Celestia, and more data availability solutions are already integrated into Arbiturm chains.
...
In fact, Arbitrum One and Arbitrum Nova, can be considered the first Arbitrum chains, to demonstrate the capability of the technology. The proven track record of the technology has led to an explosion of projects adopting the technology stack. 

To learn more, please visit the [Arbitrum chain website which includes developer documentation.](https://arbitrum.io/launch-chain)
...
- **Deploy on any chain.** Projects are allowed to deploy an Arbitrum chain on any blockchain network including Ethereum, Bitcoin, other L2s, etc. 
