...
### Resolution (RS)
 - The Ethereum consensus client instance causing the consensus lag was
restarted.
...
![Graph showing: overlaid graph of message size (#), backlog data amount, and L1 Surplus](./assets/15_Dec_2023_Figure_1.png)

![Graph showing: Size of inscription mint over the relevant period](./assets/15_Dec_2023_Figure_2.png)
