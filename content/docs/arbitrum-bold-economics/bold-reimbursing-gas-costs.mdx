...
This document will cover how we reimburse costs for gas to honest parties. The main document describing how we reimburse challenge bonds is [here](/arbitrum-bold-economics/bold-reimbursing-challenge-bonds). The document describing how we pay “service fees” to proposers is [here](/arbitrum-bold-economics/bold-reimbursing-service-fees).
...
{/* On our page about [reimbursing service fees](/arbitrum-bold-economics/bold-reimbursing-service-fees), */}
