...
This pattern applies to all ArbitrumDAO governance documents that are published here on the ArbitrumDAO docs portal, excluding [The Constitution of the ArbitrumDAO](/dao-constitution). Examples include:

* Conceptual documentation

  * [Delegates and delegation](/concepts/delegate-delegation)
  * [Lifecycle and anatomy of an AIP](/concepts/lifecycle-anatomy-aip-proposal)
* How-to documentation

  * [Apply to become a delegate](/how-tos/apply-become-delegate)
  * [Submit an AIP](/how-tos/create-submit-dao-proposal)
...
No. The private preview content pattern does **not** apply to [The Constitution of the ArbitrumDAO](/dao-constitution).
