...
<ol>
<li>Each seat in the Security Council is up for election once a year; the DAO can wait until the next appropriate election vote the member out then.</li>
...
<p>Visit the Tally governance page! <br /> <a href="https://www.tally.xyz/gov/arbitrum">https://www.tally.xyz/gov/arbitrum</a></p>
