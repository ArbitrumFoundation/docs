...
<ul>
<li>tokens owned by the <a href="/dao-glossary#arbitrum-dao">Arbitrum DAO</a></li>
<li>tokens owned by <a href="/dao-glossary#the-arbitrum-foundation">The Arbitrum Foundation</a></li>
</ul>
<p><br /> Votable tokens give their holders voting power in direct proportion to the quantity of tokens held. More $ARB == more voting power.</p>

### Voting period [#voting-period]
<p>14-16 days after an <a href="/dao-glossary#arbitrum-improvement-proposal-aip">Arbitrum Improvement Proposal (AIP)</a> is successfully submitted during which members of the <a href="/dao-glossary#arbitrum-dao">Arbitrum DAO</a> can vote for or against.<br /> </p>
